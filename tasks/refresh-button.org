...
- Add button above the "Clasificación" title
...
* Success Criteria
- [ ] Refresh button visible in classification view
- [ ] Button disabled and shows "Cargando..." during refresh
- [ ] Clicking button triggers data reload from Supabase
- [ ] Classification updates with fresh data after refresh
- [ ] Component is reusable across other views
